(window["webpackJsonpweather"] = window["webpackJsonpweather"] || []).push([[667],{
...
/*#__PURE__*/
react_default().createContext(null);
...
var hoist_non_react_statics_cjs = __webpack_require__(5337);
  ...
  return function wrapWithConnect(WrappedComponent) {
    ...
    function ConnectFunction(props) {
      ...
      var ContextToUse = (0,react.useMemo)(function () {
        ...
        return propsContext && propsContext.Consumer && (0,react_is.isContextConsumer)(react_default().createElement(propsContext.Consumer, null)) ? propsContext : Context;
      ...
      var renderedWrappedComponent = (0,react.useMemo)(function () {
        return react_default().createElement(WrappedComponent, (0,esm_extends/* default */.Z)({}, actualChildProps, {
          ref: forwardedRef
        }));
      ...
      var renderedChild = (0,react.useMemo)(function () {
        if (shouldHandleStateChanges) {
          ...
          return react_default().createElement(ContextToUse.Provider, {
    ...
    var Connect = pure ? react_default().memo(ConnectFunction) : ConnectFunction;
    Connect.WrappedComponent = WrappedComponent;
    Connect.displayName = displayName;

    if (forwardRef) {
      var forwarded = react_default().forwardRef(function forwardConnectRef(props, ref) {
        return react_default().createElement(Connect, (0,esm_extends/* default */.Z)({}, props, {
          forwardedRef: ref
        }));
      });
...
function verifyPlainObject(value, displayName, methodName) {
  if (!/* unused export */ undefined(value)) {
    /* unused export */ undefined(methodName + "() in " + displayName + " must return a plain object. Instead received " + value + ".");
  }
}
...
function verify(selector, methodName, displayName) {
  if (!selector) {
    ...
    if (!Object.prototype.hasOwnProperty.call(selector, 'dependsOnOwnProps')) {
      /* unused export */ undefined("The selector for " + methodName + " of " + displayName + " did not specify a value for dependsOnOwnProps.");
    }
  }
}
